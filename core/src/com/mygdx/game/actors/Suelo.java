...
public class Suelo extends Actor {
     ...
     */
    public Suelo(World world, Vector2 position){
    ...
    private void createFixture(){
        ...
        this.fixture.setUserData(USER_SUELO);
    ...
    public void draw(Batch batch, float parentAlpha) {
        setPosition(this.body.getPosition().x - 10f, this.body.getPosition().y - 0.6f);
        batch.draw(AssetMan.getAssetMan().getSuelo(), getX(),getY(), 20f,1.2f);
    }
    ...
    public Vector2 getBodyPositionSuelo() {
